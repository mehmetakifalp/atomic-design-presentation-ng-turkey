...
@NgModule({
  ...
  exports: [ AtomsLinkComponent, AtomsInputComponent, AtomsButtonComponent,AtomsIconComponent, AtomsLinkWithIconComponent, MoleculesNavSearch, MoleculesNavMenuComponent],
  declarations: [AtomsLinkComponent, AtomsInputComponent, AtomsButtonComponent,AtomsIconComponent,AtomsLinkWithIconComponent,  MoleculesNavSearch, MoleculesNavMenuComponent]
})
